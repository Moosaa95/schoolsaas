            ...
            <div className="flex flex-col w-full gap-4 xl:w-1/3">
                <div className="p-4 bg-white rounded-md">
                    ...
                    <div className="flex flex-wrap gap-4 mt-4 text-xs text-gray-500">
                        <Link to="" className="p-3 rounded-md bg-skyLight">Student&apos;s Lessons</Link>
                        <Link to="" className="p-3 rounded-md bg-purpleLight">Student&apos;s Teachers</Link>
                        <Link to="" className="p-3 rounded-md bg-pink-50">Student&apos;s Exams</Link>
                        <Link to="" className="p-3 rounded-md bg-skyLight">Student&apos;s ASsigments</Link>
                        <Link to="" className="p-3 rounded-md bg-yellowLight">Student&apos;s Results</Link>
                    </div>
                </div>
                <Performance />
                <Annoucements />
