...
import { role, subjects } from "../../../../lib/data";
        ...
        <tr key={item.id} className="text-sm border-b border-gray-200 even:bg-slate-50 hover:bg-purpleLight">
            ...
            <td>
                <div className="flex items-center gap-2">
                    <Link to={`/list/subjects/${item.id}`} className="flex gap-4">
                        {role === "admin" && <ActionButton icon={Edit2Icon} ariaLabel="Edit Subject" tooltip="Edit" />}
